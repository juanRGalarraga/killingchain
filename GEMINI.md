...
- The project is a chat application that uses OpenAI's GEMINI API to generate responses to user queries.
...
- `sdd-explore/SKILL.md` — Investigate codebase - Use Haiku for this skill
